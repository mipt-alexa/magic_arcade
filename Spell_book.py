...
spell_book[1] = sp.AttackDirectSpell('fireball', 50, 'fireball', 'fire1', 20, 20, 0, 'Both', 'fire_projectile')
spell_book[2] = sp.AttackDirectSpell('ice spike', 50, 'ice spike', 'energy', 8, 10, 40, 'Mage', 'ice_projectile')
